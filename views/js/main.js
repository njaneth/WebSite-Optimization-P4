...
//use switch to set pizza width in order to avoid Forced Synchronous Layout and avoid use of determineDx to determine new pizza widths
...
// var pizzaDiv was originaly inside the loop
...
//I use window.innerHeight to calculate the number of pizzas depending the size of the window
  ...
  document.querySelector("#movingPizzas1").appendChild(myFragment);
  updatePositions();
});